...
<%--    </c:if>--%>
    <ul class="nav nav-pills">
        ...
        <li role="presentation" class="active"><a href="/comments/getusercomments">我的评论管理</a></li>
        <c:if test="${username!=null}">
            <div class="btn-group">
    ...
    <ul class="pagination">
        ...
        <li><a href="getusercomments?curr=${curr==1? 1: curr-1}">&laquo;</a></li>

        <c:forEach begin="1" end="${pages}" step="1" varStatus="m">
            <c:if test="${curr == m.index }">
                <li class="active"><a href="getusercomments?curr=${m.index}">${m.index}</a></li>
            </c:if>

            <c:if test="${curr != m.index }">
                <li><a href="getusercomments?curr=${m.index}">${m.index}</a></li>
            </c:if>

        </c:forEach>

        <li><a href="getusercomments?curr=${curr==pages? pages: curr+1}">&raquo;</a></li>
    </ul>
</div>
            ...
            <div class="modal-body">
                <form id="setcoments">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  id="sname" name="name" disabled="true">
                    </div>

                    <div class="form-group">
                        <label class="control-label">邮箱:</label>
                        <input type="text" class="form-control"  id="smail" name="mail" disabled="true">

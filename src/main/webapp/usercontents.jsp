...
<div class="container">
    ...
    <ul class="nav nav-pills">
        ...
        <li role="presentation" class="active"><a href="/contents/getusercontents">我的文章管理</a></li>
...
<%--                <td>${d.text}</td>--%>
                ...
                <td>
                    ...
                    <a href="/comments/getcidComments?cid=${d.cid}">查看评论</a>
                </td>
            </tr>
    ...
    <ul class="pagination">
        ...
        <li><a href="getusercontents?curr=${curr==1? 1: curr-1}">&laquo;</a></li>

        <c:forEach begin="1" end="${pages}" step="1" varStatus="m">
            <c:if test="${curr == m.index }">
                <li class="active"><a href="getusercontents?curr=${m.index}">${m.index}</a></li>
            </c:if>

            <c:if test="${curr != m.index }">
                <li><a href="getusercontents?curr=${m.index}">${m.index}</a></li>
            </c:if>

        </c:forEach>

        <li><a href="getusercontents?curr=${curr==pages? pages: curr+1}">&raquo;</a></li>
    </ul>
</div>
